...
def load(data_dir):
    data_set = []
    count = 0
    img_label = np.zeros((784, 1), dtype=int)
    for guy in os.listdir(data_dir):
        ...
        for i in os.listdir(person_dir):
            ...
            if guy == 'A-sky':
                ...
                img_label[count] = 2
            elif guy == 'C-thick-dark':
                img_label[count] = 3
            elif guy == 'D-thick-white':
                img_label[count] = 4
            elif guy == 'E-veil':
                img_label[count] = 5
            count += 1
...
if __name__ == '__main__':
    data_dir = "C:/Users/76505/Desktop/cloudset/swimcat/"
    data_set,img_label = load(data_dir)
    np.save('datafiles/swimcat_set.npy',data_set)
    np.save('datafiles/swimcat_label.npy',img_label)